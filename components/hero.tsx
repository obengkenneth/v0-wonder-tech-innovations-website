  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-background to-accent/5">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 text-balance" data-aos="fade-up" data-aos-delay="200">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12" data-aos="fade-up" data-aos-delay="400">
          <Link
            href="/contact"
            className="px-8 py-4 bg-primary text-primary-foreground rounded-lg font-semibold btn-hover flex items-center justify-center gap-2"
          >
            Let's Build Together <ArrowRight size={20} />
          </Link>
          <Link
            href="/portfolio"
            className="px-8 py-4 border-2 border-primary text-primary rounded-lg font-semibold btn-hover"
          >
            View Our Work
          </Link>
        </div>

        <div className="grid grid-cols-3 gap-4 max-w-md mx-auto text-sm" data-aos="fade-up" data-aos-delay="500">
          <div className="p-3 bg-card rounded-lg border border-border card-hover">
